...
Return ONLY a valid JSON object with the exact following schema:
{
  ...
  "duration": "string",
  "lowestPrices": {
    "flight": "lowest available flight price in INR (number as string)",
    "train": "lowest available train price in INR (number as string)",
    "bus": "lowest available bus price in INR (number as string)",
    "cab": "lowest available cab/taxi price in INR (number as string)",
    "hotel": "lowest available hotel price per night in INR (number as string)",
    "villa": "lowest available villa price per night in INR (number as string)"
  },
  "itinerary": [{"day": number, "title": "string", "description": "string"}],
  "recommendedHotels": [{"name": "string", "price": number, "rating": number}]
}
Generate highly realistic prices based on general current market knowledge.`;
